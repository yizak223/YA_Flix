  ...
  fetch(`https://api.themoviedb.org/3/movie/${movie_id}?api_key=bc1f09cc15ddc7d57d1d665f10e1e5a6&language=en-US&append_to_response=credits`)
    ...
    .then((movieData) => {
      ...
      if (movieData.success == false) {
        ...
        const isLiked = favourite_movies.includes(movieData.id);
                                            ...
                                            <div id='containerContent'>
                                              <div id='secContainerContent'>
                                                <div id='titleContainer'>
                                                  ...
                                                  <span id='spanDetails'>Year: ${movieData.release_date.substring(0, 4)} | Time: ${movieData.runtime} minutes | Genre: ${movieData.genres[0].name}</span>
                                                </div>
